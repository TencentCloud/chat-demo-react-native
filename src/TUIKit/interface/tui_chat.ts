...
export type MessageElement = React.ComponentType<{message: V2TimMessage,multiSelectCallback?:()=>void,isSelectMode?:boolean,messageSelctedCallback?:(msgID:string,isAdd:boolean)=>void}>;
